...
static const char *applaunchercmd[] = {"/home/joshua/.config/rofi/launchers/type-3/launcher.sh"};
static const char *snippetlaunchercmd[] = {"/home/joshua/.config/usr-scripts/insert_with_rofi.sh"};
static const char *emojilaunchercmd[] = {"rofimoji", "--action", "copy", "--skin-tone", "neutral", NULL};
